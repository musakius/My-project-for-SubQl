...
function getBlock(instanceId, api) {
  return (0, _index2.memo)(instanceId, blockHash => api.queryAt(blockHash).pipe((0, _rxjs.switchMap)(queryAt => (0, _rxjs.combineLatest)([api.rpc.chain.getBlock(blockHash), queryAt.system.events(), queryAt.session ? queryAt.session.validators() : (0, _rxjs.of)([])])), (0, _rxjs.map)(_ref => {
