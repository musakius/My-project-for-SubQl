...
function getHeader(instanceId, api) {
  return (0, _index2.memo)(instanceId, hash => api.queryAt(hash).pipe((0, _rxjs.switchMap)(queryAt => (0, _rxjs.combineLatest)([api.rpc.chain.getHeader(hash), queryAt.session ? queryAt.session.validators() : (0, _rxjs.of)([])])), (0, _rxjs.map)(_ref => {
