...
function _extractArray2(_, _ref13) {
  let {
    len: length,
    type
  } = _ref13;
...
function _extractBitSequence2(_, _ref14) {
  let {
    bitOrderType,
    bitStoreType
  } = _ref14;
...
function _extractCompact2(_, _ref15) {
  let {
    type
  } = _ref15;
  return (0, _encodeTypes.withTypeString)(this.registry, {
...
function _extractComposite2(lookupIndex, _ref16, _ref17) {
  let {
    params,
    path
  } = _ref16;
...
function _extractCompositeSet2(_, params, fields) {
  ...
  return (0, _encodeTypes.withTypeString)(this.registry, {
    ...
    sub: this.getSiType(params[0].type.unwrap()).def.asVariant.variants.map(_ref20 => {
      let {
        index,
        name
      } = _ref20;
...
function _extractSequence2(lookupIndex, _ref21) {
  let {
    type
  } = _ref21;
...
function _extractVariant2(lookupIndex, _ref22, _ref23) {
  let {
    params,
    path
  } = _ref22;
...
function _extractVariantEnum2(lookupIndex, variants) {
  ...
  [...variants].sort((a, b) => a.index.cmp(b.index)).forEach(_ref25 => {
    let {
      fields,
      index,
      name
