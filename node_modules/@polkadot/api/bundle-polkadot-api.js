const polkadotApi = (function (exports, keyring, util, types, utilCrypto) {
        ...
        value: response => {
          ...
          try {
            ...
            if (subscription) {
              ...
              _classPrivateFieldBase(this, _subscriptions$1)[_subscriptions$1][subId] = { ...subscription,
                method,
                params
  ...
  ***************************************************************************** */
  ...
  const versioned$1 = [{
    ...
    types: util.objectSpread({}, sharedTypes$1)
  }];
  ...
  function injectFunctions(instanceId, api, derives) {
    ...
    const isIncluded = s => !checks[s] || checks[s].instances.some(filterQueryKeys) || checks[s].withDetect && checks[s].instances.some(filterInstances);
